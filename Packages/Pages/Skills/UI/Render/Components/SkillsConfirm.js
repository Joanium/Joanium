  ...
  return backdrop && iconEl && titleEl && bodyEl && okBtn
    ? ('enable' === type
        ? ((iconEl.className = 'skills-confirm-icon skills-confirm-icon--enable'),
          ...
          (bodyEl.textContent = `This will activate all ${totalCount} skill${1 !== totalCount ? 's' : ''} and inject them into every AI conversation.`),
          (okBtn.className =
        ...
        : ((iconEl.className = 'skills-confirm-icon skills-confirm-icon--disable'),
          ...
          (bodyEl.textContent = `This will deactivate all ${enabledCount} active skill${1 !== enabledCount ? 's' : ''}. The AI will no longer use them.`),
          (okBtn.className =
