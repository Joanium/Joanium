    ...
    <div class="skills-scroll">
      ...
      <div id="skills-search-wrapper" class="page-search-wrapper" hidden>
        <div class="page-search-box">
          ...
          <input type="text" id="skills-search" class="page-search-input" placeholder="${t('skills.searchPlaceholder')}" autocomplete="off" spellcheck="false" />
      ...
      <div id="skills-empty" class="page-empty" hidden>
        ...
        <h3>${t('skills.noSkillsYet')}</h3>
        <p>${t('skills.noSkillsDesc')}</p>
        <button id="skills-go-marketplace" class="page-empty-cta" type="button">${t('skills.goMarketplace')}</button>
      </div>
